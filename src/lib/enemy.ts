...
export const EnemySrc = {
  "acid ooze": await import(`../assets/images/enemy/${EnemySpecies[0]}.png`),
  "humongous ettin": await import(
    `../assets/images/enemy/${EnemySpecies[1]}.png`
  ),
  "wretched fomorian": await import(
    `../assets/images/enemy/${EnemySpecies[2]}.png`
  ),
  "werewolf stalker": await import(
    `../assets/images/enemy/${EnemySpecies[3]}.png`
  ),
  "swamp troll": await import(`../assets/images/enemy/${EnemySpecies[4]}.png`),
  "ocular watcher": await import(
    `../assets/images/enemy/${EnemySpecies[5]}.png`
  ),
  "intellect devourer": await import(
    `../assets/images/enemy/${EnemySpecies[6]}.png`
  ),
  "red cap": await import(`../assets/images/enemy/${EnemySpecies[7]}.png`),
  "clawing harpy": await import(
    `../assets/images/enemy/${EnemySpecies[8]}.png`
  ),
};
...
export class Enemy {
  ...
  draw() {
    ...
    enemyImage.src = EnemySrc[this.species].default;
