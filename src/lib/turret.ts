...
export const TowerSrc = {
  normal: await import(`../assets/images/turret/${TowerSpecies[0]}.png`),
  fire: await import(`../assets/images/turret/${TowerSpecies[1]}.png`),
  light: await import(`../assets/images/turret/${TowerSpecies[2]}.png`),
  ice: await import(`../assets/images/turret/${TowerSpecies[3]}.png`),
  poison: await import(`../assets/images/turret/${TowerSpecies[4]}.png`),
  energy: await import(`../assets/images/turret/${TowerSpecies[5]}.png`),
};
...
export class Turret {
  ...
  async draw() {
    ...
    towerImage.src = TowerSrc[this.species].default;
  ...
  hover(html: HTMLDivElement) {
    ...
    divDescription.innerHTML = `${capitalize(this.description)} tower`;
